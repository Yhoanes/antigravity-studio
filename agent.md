...
- **ADR-068**: Saneamiento Profundo del Repositorio, Eliminaci�n de Residuos y Blindaje del Pipeline Can�nico de Compilaci�n (`scripts/build_release.ps1`)
- **ADR-069**: Implementaci�n de Natural Touch Scrolling Invertido y Recuperaci�n Resiliente de Sesi�n (SPEC-053)
