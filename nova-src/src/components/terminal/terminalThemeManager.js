	...
	constructor() {
		this.themes = {
			nova: {
				...
				selectionInactiveBackground: "rgba(0, 240, 255, 0.15)",
				scrollbarSliderBackground: "rgba(0, 240, 255, 0.2)",
				scrollbarSliderHoverBackground: "rgba(0, 240, 255, 0.4)",
				scrollbarSliderActiveBackground: "rgba(0, 240, 255, 0.6)",
				overviewRulerBorder: "#1e293b",
				black: "#090d16",
				red: "#ef4444",
				green: "#10b981",
				yellow: "#f59e0b",
