...
const nova = createBuiltInTheme("Nova", "dark", "free");
nova.primaryColor = "rgb(9, 13, 22)"; // #090d16 Deep Void
nova.darkenedPrimaryColor = "rgb(3, 7, 18)"; // #030712
nova.secondaryColor = "rgb(17, 24, 39)"; // #111827 Dark Slate
nova.secondaryTextColor = "rgb(148, 163, 184)"; // #94a3b8
nova.primaryTextColor = "rgb(226, 232, 240)"; // #e2e8f0 Code Text
nova.activeColor = "rgb(0, 240, 255)"; // #00f0ff Supernova Cyan
nova.linkTextColor = "rgb(139, 92, 246)"; // #8b5cf6 Stellar Violet
nova.borderColor = "rgba(30, 41, 59, 0.6)"; // #1e293b
nova.popupBackgroundColor = "rgb(17, 24, 39)";
nova.popupTextColor = "rgb(226, 232, 240)";
nova.popupActiveColor = "rgb(0, 240, 255)";
nova.buttonBackgroundColor = "rgb(0, 240, 255)";
nova.buttonTextColor = "rgb(9, 13, 22)";
nova.scrollbarColor = "rgba(0, 240, 255, 0.2)";
nova.preferredEditorTheme = "dracula";
nova.preferredTerminalTheme = "nova";
