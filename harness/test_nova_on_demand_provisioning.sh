...
echo -n "6. Verificando existencia de APK Thin Client (NovaIDE-v1.0.13-ARM64.apk)... "
APK_PATH="NovaIDE-v1.0.13-ARM64.apk"
if [ ! -f "$APK_PATH" ]; then
    APK_PATH="NovaIDE-v1.0.12-ARM64.apk"
fi
if [ ! -f "$APK_PATH" ]; then
    APK_PATH="NovaIDE-v1.0.11-ARM64.apk"
fi
if [ ! -f "$APK_PATH" ]; then
    APK_PATH="NovaIDE-v1.0.10-ARM64.apk"
fi
if [ ! -f "$APK_PATH" ]; then
    APK_PATH="NovaIDE-v1.0.9-ARM64.apk"
fi
if [ ! -f "$APK_PATH" ]; then
