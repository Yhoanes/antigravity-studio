...
echo -n "6. Verificando existencia de APK Thin Client (NovaIDE-v1.0.5-ARM64.apk)... "
...
if [ ! -f "$APK_PATH" ]; then
    echo "FALLO: No se encontró NovaIDE-v1.0.5-ARM64.apk en la raíz del repositorio."
    exit 1
fi
