...
# 16. Verificar versionado v2.8.1 y android-versionCode 20801 en configuración (Criterio de Versionado)
echo -n "16. Verificando versión 2.8.1 y versionCode 20801 en configuración... "
grep -q 'version="2.8.1"' "$CONFIG_XML" || { echo "FALLO: config.xml no tiene versión 2.8.1"; exit 1; }
grep -q 'android-versionCode="20801"' "$CONFIG_XML" || { echo "FALLO: config.xml no tiene android-versionCode 20801"; exit 1; }
grep -q '"version": "2.8.1"' "$PACKAGE_JSON" || { echo "FALLO: package.json no tiene versión 2.8.1"; exit 1; }
echo "[OK]"
...
echo -n "68. Verificando versión 2.8.1 y versionCode 20801 en configuración (MODEL-FIX)... "
grep -q 'version="2.8.1"' "$CONFIG_XML" || { echo "FALLO: config.xml no tiene versión 2.8.1"; exit 1; }
grep -q 'android-versionCode="20801"' "$CONFIG_XML" || { echo "FALLO: config.xml no tiene android-versionCode 20801"; exit 1; }
grep -q '"version": "2.8.1"' "$PACKAGE_JSON" || { echo "FALLO: package.json no tiene versión 2.8.1"; exit 1; }
echo "[OK]"
...
# ==============================================================================
echo -n "78. Verificando versión 2.8.1 y versionCode 20801 en configuración (VERSIONADO)... "
grep -q 'version="2.8.1"' "$CONFIG_XML" || { echo "FALLO: config.xml no tiene versión 2.8.1"; exit 1; }
grep -q 'android-versionCode="20801"' "$CONFIG_XML" || { echo "FALLO: config.xml no tiene android-versionCode 20801"; exit 1; }
grep -q '"version": "2.8.1"' "$PACKAGE_JSON" || { echo "FALLO: package.json no tiene versión 2.8.1"; exit 1; }
echo "[OK]"
...
grep -q 'version="2.8.1"' "$CONFIG_XML" || { echo "FALLO: config.xml no tiene versi�n 2.8.1"; exit 1; }
grep -q 'android-versionCode="20801"' "$CONFIG_XML" || { echo "FALLO: config.xml no tiene android-versionCode 20801"; exit 1; }
grep -q '"version": "2.8.1"' "$PACKAGE_JSON" || { echo "FALLO: package.json no tiene versi�n 2.8.1"; exit 1; }
echo "[OK]"
